<script>
  ...
  const resourceLinks = [
    ...
    },
    {
      ...
      url: 'https://maps.mecklenburgcountync.gov/openmapping/data.html#flood'
    },
    {
      name: 'Watershed data on Open Mapping',
      url: 'https://maps.mecklenburgcountync.gov/openmapping/data.html#watershed'
    },
    {
      name: 'Storm Water data on Open Mapping',
      url: 'https://maps.mecklenburgcountync.gov/openmapping/data.html#storm'
    }
  ]
  ...
  function watershed(lng, lat) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_point/watersheds/${lng},${lat},4326?${jsonToURL(params)}`)
  ...
  function district(pid) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_feature/tax_parcels/post_construction_layers?${jsonToURL(params)}`)
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
          districtReport = {
  ...
  function brownfields(pid) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_feature/tax_parcels/nc_deq_brownfields?${jsonToURL(params)}`)
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
          brownfieldReport = {
  ...
  function conservation(pid) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_feature/tax_parcels/stormwater_conservation_easements?${jsonToURL(params)}`)
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
          brownfieldReport = {
  ...
  function waterqualitybuffer(pid) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_feature/tax_parcels/water_quality_buffers?${jsonToURL(params)}`)
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
          waterQualityReport = {
  ...
  function floodplain(pid) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_feature/tax_parcels/view_regulated_floodplains?${jsonToURL(params)}`)
      .then(response => response.json())
      .then(data => {
        if (data.length > 0) {
          floodplainReport = {
  ...
  function soils(pid) {
    ...
    fetch(`https://maps.mecklenburgcountync.gov/dirt/api/v1/intersect_feature/tax_parcels/soil?${jsonToURL(params)}`)
      .then(response => response.json())
      .then(data => {
