<script>
  ...
  function fetchData() {
    ...
    // zoning
    fetch(`https://mcmap.org/api/v1/intersect_point/view_zoning/${$location.lnglat.join(',')},4326?${jsonToURL({
    ...
    // ownership
    fetch(`https://mcmap.org/api/v1/query/cama_tb_pubowner?${jsonToURL({
    ...
    // appraisal
    fetch(`https://mcmap.org/api/v1/query/cama_tb_pubparcelinfo?${jsonToURL({
    ...
    // sale history
    fetch(`https://mcmap.org/api/v1/query/cama_tb_pubsales?${jsonToURL({
    ...
    // land use
    fetch(`https://mcmap.org/api/v1/query/cama_tb_publand,cama_ctb_publanduse?${jsonToURL({
    ...
    // buildings
    fetch(`https://mcmap.org/api/v1/query/cama_tb_pubbuilding?${jsonToURL({
    ...
    // building permits
    fetch(`https://mcmap.org/api/v1/query/building_permits?${jsonToURL({
